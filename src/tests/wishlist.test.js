...
describe("addToWishlist", () => {
  ...
  before(async () => {
    ...
    it("should add product to wishlist", async () => {
      ...
      expect(res.body.message).to.have.equal('Product has been added to your wishlist');
    });
...
describe("removeFromWishlist", () => {
  ...
  it("should first add product to wishlist", async () => {
    ...
    it("should remove product from wishlist", async () => {
      ...
      .set("authorization", `Bearer ${token}`);
      expect(res.statusCode).to.equal(200);
      expect(res.body.message).to.have.equal('Product has been removed from your wishlist');
    });
