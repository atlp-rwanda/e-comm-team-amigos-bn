...
const sendResetMail = (recepient, subject, text, url) => new Promise((resolve, reject) => {
  ...
  const mailOption = {
    ...
    html: `<!doctype html>
      ...
      * {
      ...
      <tr>
      <td align="center">
      <div style="line-height:20px;text-align:center;"><span style="color:#979dad;font-family:Roboto,Arial,sans-serif;font-size:15px;line-height:20px;text-align:center;">CONNECT YOUR APPS</span></div>
      </td>
      </tr>
      <tr>
      <td height="12" style="height:12px; min-height:12px; line-height:12px;"></td>
      ...
      <tr>
      <td align="center">
      <div style="line-height:40px;text-align:center;"><span class="text-66174120 text-03252176" style="color:#363a57;font-weight:700;font-family:Roboto,Arial,sans-serif;font-size:36px;line-height:40px;text-align:center;">Buy for better price</span></div>
      </td>
      </tr>
      <tr>
      <td height="12" style="height:12px; min-height:12px; line-height:12px;"></td>
      ...
      <!--[if mso]>
                          ...
                          <![endif]-->
      <a href="${url}" style="white-space:nowrap;background-color:#339989;border-radius:8px; display:inline-block;text-align:center;color:#ffffff;font-weight:700;font-family:Roboto,Arial,sans-serif;font-size:15px;line-height:44px;width:130px; -webkit-text-size-adjust:none;mso-hide:all;">${text}</a>
      </div>
      </td>
      </tr>
      </table>
